...
wandb.init(project="j_la", name="vnet_with_contrastive")
...
def self_train2(args, pre_snapshot_path, self_snapshot_path):
    model1 = create_Vnet()
    ...
    for epoch in iterator:
        ...
        for step, ((img_a, lab_a), (img_b, lab_b), (unimg_a, unlab_a), (unimg_b, unlab_b)) in enumerate(
            ...
            outputs_l, feat_l = model1(mixl_img)
            outputs_u, feat_u = model1(mixu_img)
            ...
            outputs_l_2, feat_l2 = model2(mixl_img)
            outputs_u_2, feat_u2 = model2(mixu_img)

            loss_contrast_l = compute_contrastive_loss(feat_l, model1.projection_head)
            loss_contrast_ul = compute_contrastive_loss(feat_u, model1.projection_head)
            ...
            wandb.log({
                ...
                "loss_contrast_1": (loss_contrast_l + loss_contrast_ul).item(),
                "loss_contrast_2": (loss_contrast_l2 + loss_contrast_ul2).item(),
            })                    
        ...
        if epoch % 5 == 0:
            ...
            if dice_sample > best_dice:
                ...
                wandb.log({"best_dice_vnet": best_dice})
            ...
            if dice_sample2 > best_dice2:
                ...
                wandb.log({"best_dice_res": best_dice2})
            ...
            if mean_dice_sample > mean_best_dice:
                ...
                wandb.log({"best_dice_mean": mean_best_dice})
...
if __name__ == "__main__":
    ...
    shutil.copy('../code/LA_train2.py', self_snapshot_path)
